...
const Index = () => {
  ...
  const trendingChartRef = useRef<HTMLCanvasElement | null>(null);

  useEffect(() => {
    if (trendingChartRef.current) {
      new Chart(trendingChartRef.current, {
      ...
      <div className="flex-1 p-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mt-6">
          <h3 className="text-xl font-semibold mb-4">
            <i className="fas fa-chart-line mr-2"></i> Topic Popularity Trends
          </h3>
          <canvas ref={trendingChartRef} id="trendingChart"></canvas>
        </div>
      </div>
    </Layout>
  );
